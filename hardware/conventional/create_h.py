...
if __name__ == "__main__":
    text = 'conventional'
    weight(f'../HLS/{text}/u.h', 'double', 'U', [len(np.load(f'../HLS/{text}/U.npy'))], f'../HLS/{text}/U.npy')
    weight(f'../HLS/{text}/win.h', 'float', 'Win', [len(np.load(f'../HLS/{text}/Win.npy'))], f'../HLS/{text}/Win.npy')
    weight(f'../HLS/{text}/x.h', 'float', 'X', [len(np.load(f'../HLS/{text}/X.npy'))], f'../HLS/{text}/X.npy')
    weight(f'../HLS/{text}/wout.h', 'float', 'Wout', [len(np.load(f'../HLS/{text}/Wout.npy'))], f'../HLS/{text}/Wout.npy')
    weight(f'../HLS/{text}/d.h', 'float', 'D', [len(np.load(f'../HLS/{text}/D.npy'))], f'../HLS/{text}/D.npy')